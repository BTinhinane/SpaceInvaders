...
static uint32_t frameBuf0 = (uint32_t)(0xD0000000); // frame buffer 1
static uint32_t frameBuf1 = (uint32_t)(0xD00BB800); // frame buffer 2
static uint32_t frameBuf2 = (uint32_t)(0xD0177000); // animation storage
...
void touchgfx_init()
{
    ...
    hal.setFrameBufferStartAddresses((uint16_t*)frameBuf0, (uint16_t*)0, (uint16_t*)frameBuf1);
