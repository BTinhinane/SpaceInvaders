...
static uint16_t* doubleBufferBase = 0;
...
void STM32H7HAL_DSI::setFrameBufferStartAddresses(void* frameBuffer, void* doubleBuffer, void* animationStorage)
{
    currFbBase = reinterpret_cast<uint16_t*>(frameBuffer);
    doubleBufferBase = reinterpret_cast<uint16_t*>(doubleBuffer);
...
void HAL_DSI_TearingEffectCallback(DSI_HandleTypeDef* hdsi)
{
    ...
    if (!doubleBufferBase && HAL::getInstance())
    {
